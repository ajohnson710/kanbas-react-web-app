...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <h3>Changing the description of a todo</h3>
            ...
            <h3>Changing the completed status of a todo</h3>
            <a href={`${API}/${todo.id}/completed/:${todo.completed}`} className="btn btn-primary float-end">
                Update Todo</a>
            <input defaultValue={todo.id} className="checkbox w-25 float-start me-2"
                onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
            <h4 className="float-start me-2">Completed?</h4>
            <input defaultChecked={todo.completed} className="form-check-input w-10 float-start" type="checkbox"
